...
class TestFindResultsFile(unittest.TestCase):
    """Test finding results file"""
...
class TestLoadSymbolCategories(unittest.TestCase):
    ...
    def test_successful_import(self):
        ...
        # Actual import success depends on investment_score_sheet module existing
    ...
    def test_import_error(self):
        ...
        # This will fail if investment_score_sheet doesn't exist
...
class TestCreateVisualization(unittest.TestCase):
    ...
    def test_create_visualization(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('visualize_scores.find_results_file', return_value=results_file):
                result_path = create_visualization(str(output_file))
