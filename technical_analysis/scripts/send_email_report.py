...
def generate_email_html():
    ...
    <body>
        <div class="header">
            <h1>📊 Weekly Technical Analysis Report</h1>
            <p>Generated: {date}</p>
        </div>
        <div class="content">
...
def send_via_sendgrid(subscribers, html_content):
    ...
    for subscriber in subscribers:
        ...
        try:
            ...
            print(f"✓ Sent report to {subscriber} (Status: {response.status_code})")
...
def send_via_smtp(subscribers, html_content):
    ...
    try:
        ...
        for subscriber in subscribers:
            ...
            print(f"✓ Sent report to {subscriber}")
...
def main():
    ...
    if success:
        print(f"\n✓ Successfully sent reports to {len(subscribers)} subscriber(s)")
    else:
